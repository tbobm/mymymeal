...
/**
 * Presence of a row means the supplement was taken on that [date]. No timestamp. [doseGrams] is
 * only ever set when the parent [SupplementEntity.tracksDose] is true -- null otherwise.
 */
@Entity(
